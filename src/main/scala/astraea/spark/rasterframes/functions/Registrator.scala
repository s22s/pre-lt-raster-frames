...
private[rasterframes] object Registrator {
  def register(sqlContext: SQLContext): Unit = {
    ...
    sqlContext.udf.register("st_tileToArrayInt", UDFs.tileToArray[Int])
    sqlContext.udf.register("st_tileToArrayDouble", UDFs.tileToArray[Double])
    ...
    sqlContext.udf.register("st_localAggStats", UDFs.localAggStats)
    sqlContext.udf.register("st_localAggMax", UDFs.localAggMax)
    sqlContext.udf.register("st_localAggMin", UDFs.localAggMin)
    sqlContext.udf.register("st_localAggMean", UDFs.localAggMean)
